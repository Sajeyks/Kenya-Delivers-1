# Generated by Django 3.1.6 on 2021-05-22 13:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency_logo', models.CharField(max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('agency_Title', models.CharField(max_length=50)),
                ...
                ('agency_slug', models.CharField(default=1, max_length=200)),
                ('agency_Category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='service.agencycategory', verbose_name='Category')),
            ],
            options={
